...
export class EmrStudio extends Construct {
  ...
  constructor(scope: Construct, name: string, props: EmrStudioProps) {
    ...
    const engineSecurityGroup = new EmrStudioEngineSecurityGroup(this, 'Engine', { vpc: baseVpc, workspaceSg: workSpaceSecurityGroup.entity });
    engineSecurityGroup.addIngress4WorkSpace(workSpaceSecurityGroup.entity);
